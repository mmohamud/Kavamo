Feature: User can list all reading tips by status
  ...
  Scenario: UI prints all reading tips marked as read
    Given commands selaa lukuvinkkejä (2) and listaa lukuvinkit statuksen mukaan (3) and luetut (1) are selected
    When commands palaa alkuun (5) and lopeta (3) are selected 
    Then  the system prints "5 Mika Walteri Sinuhe egyptiläinen kirja Luettu "